...
const orderStatusChange = async (e) => {
  ...
  try{
      const data = await axios.patch(`${process.env.REACT_APP_API}/api/v1/b_manager/order-status`, {id: id, startDate: startDate, status: value})
              ...
              return (
                ...
                <div className="about-project">
                  ...
                  <div>
                    ...
                    <span onClick={orderStatusChange}>
                      <select>
