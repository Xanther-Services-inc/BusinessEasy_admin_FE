...
useEffect(() => {
  ...
  return (
    ...
    <Jumbotron>
      ...
      <Col md={6}><h1>All Orders</h1></Col>
            <Col md={6}>
                <Button type="primary" ghost onClick={() => setOrders(data)}>All</Button>
                </Col>
                <Col md={6}>
                <Button type="primary" ghost onClick={() => filterItem('Paid')}>Paid</Button>
                </Col>
                <Col md={6}>
                <Button type="primary" ghost onClick={() => filterItem('Due')}>Due</Button>
                </Col>
      </Row>
      <br />
      <Row gutter={25}>
